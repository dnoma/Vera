...
|---|---|---:|---:|
| Correctness | Issue accuracy | 100.0% | 100.0% |
| Evidence | Evidence validity (span pointers) | 100.0% | 100.0% |
| Evidence | Minimal sufficiency (median) | 0.250 | 0.250 |
| Evidence | Evidence units cited (median) | 3.0 | 3.0 |
| Evidence | Authority appropriateness (operative) | 66.7% | 50.0% |
| Trace | Trace completeness (cited or assumption) | n/a | 100.0% |
| Contestability | Counterargument present | n/a | 0.0% |
...
| Robustness | Base-score flippable rate | n/a | 0.0% |
| Robustness | Max single-argument delta (avg) | n/a | 0.006 |
| Auditability | Min interventions to flip (avg, if flippable) | n/a | n/a |
