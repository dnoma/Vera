...
- Contracts: 11, Categories: 11
- Baseline completion: 11/20 (errors: 9)
- QBAF completion: 8/20 (errors: 12)

| Axis | Metric | Baseline (Structured JSON) | QBAF (Graph + DF‑QuAD) |
|---|---|---:|---:|
| Correctness | Issue accuracy | 54.5% | 50.0% |
| Evidence | Evidence validity (span pointers) | 100.0% | 100.0% |
| Evidence | Minimal sufficiency (median) | 0.000 | 0.000 |
| Evidence | Evidence units cited (median) | 0.0 | 0.0 |
| Evidence | Authority appropriateness (operative) | 92.0% | 77.9% |
...
| Robustness | Max single-argument delta (avg) | n/a | 0.248 |
| Auditability | Min interventions to flip (avg, if flippable) | n/a | 1.00 |
